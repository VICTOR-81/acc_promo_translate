<div class="formfeedback default_block">
    <div class="container">
        <div class="formfeedback__title">Оптимизируйте налоги вашего бизнеса вместе с Jara Accounting</div>
        ...
        <form class="formfeedback__form active" data-context="phone_call">
            ...
            <label for="employee_number">
                <input type="text" id="employee_number" name="employee_number" placeholder="Количество сотрудников">
            </label>
            <label for="incoming_invoices">
                <input type="text" id="incoming_invoices" name="incoming_invoices"
                    placeholder="Количество входящих инвойсов">
            </label>
            <label for="outcoming_invoices">
                <input type="text" id="outcoming_invoices" name="outcoming_invoices"
                    placeholder="Количество исходящих инвойсов">
            </label>
            <div class="formfeedback__form-radiobtn">
                <div class="formfeedback__form-radiobtn__title">Есть ли у вас статус плательщика НДС?</div>
                <div class="formfeedback__form-radiobtn__wrapper">
                    <label for="choice"><input id="yes" type="radio" name="vat_status" value="yes">Да</label>
                    <label for="choice"><input id="no" type="radio" name="vat_status" value="no">Нет</label>
                </div>
            </div>
