...
<footer class="footer">
    ...
    <div class="footer__bottom-category">
        <div class="footer__bottom-info">
            <div class="container">
                <div class="footer__bottom-info__title">Information about the company</div>
                <p class="footer__bottom-info__text">
                The accounting agency Jara Accounting was founded in 2017 and is a subsidiary of the Jara investment fund. The agency serves both fund projects and external clients, which ensures the same high level of service.
                </p>
                <div class="footer__bottom-info__time">
                    ...
                    <span>Working hours: Mon-Fri 10:00-19:00</span>
                </div>
            </div>
        </div>
