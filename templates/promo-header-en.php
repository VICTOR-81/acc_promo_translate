            ...
            <div class="mobile">
                ...
                <nav class="navlist_grid menu_hidden">
                    ...
                    <div class="acordions acordions_line">
                        <a href="#cost-calculation" class="list_item list_item-link t_wrapper24 text-hover">Service Fee Calculation</a>
                    </div>
                    <div class="acordions acordions_line">
                        <a href="#business_cases" class="list_item list_item-link t_wrapper24 text-hover">Our Cases</a>
                    </div>
                    <div class="acordions acordions_line">
                        <a href="#reviews" class="list_item list_item-link t_wrapper24 text-hover">Review</a>
                    </div>
                    <div class="acordions acordions_line">
                        <a href="#services" class="list_item list_item-link t_wrapper24 text-hover">What we offer</a>
                    </div>
                    <div class="acordions acordions_line">
                        <a href="#help" class="list_item list_item-link t_wrapper24 text-hover">Get Help</a>
                    </div>
                    <div class="acordions acordions_line">
                        <a href="https://wa.me/995598888118" class="list_item list_item-link t_wrapper24 text-hover">
                            <img src="images/icons/VectorwhatsUp.svg" class="link_icon" />Write to whatsapp</a>
                    </div>
                    <div class="acordions acordions_line">
                        <a href="https://t.me/jaraa_bot" class="list_item list_item-link t_wrapper24 text-hover">
                            <img src="images/icons/Vectortelegram.svg" class="link_icon" />Write to Telegram</a>
                    </div>
                    <div class="acordions acordions_line">
                        <a href="mailto:accounting@jara.ge" class="list_item list_item-link t_wrapper24 text-hover">
                            <img src="images/icons/Vectoremail.svg" class="link_icon" />Write to почту</a>
                    </div>
                </nav>
            </div>
            <div class="laptop">
                <div class="contacts_container">
                    <div class="container header_top-row">
                        ...
                        <div class="header_buttons">
                            ...
                            <a href="#" id="header-consultation" class="t_wrapper18 header_button-link">Free Consultation</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="header_links">
                    <div class="container">
                        ...
                        <a href="#cost-calculation" class="t_wrapper18 header_links-item text-hover">Service Fee Calculation
                        </a>
                        <a href="#business_cases" class="t_wrapper18 header_links-item text-hover">Our Cases</a>
                        <a href="#reviews" class="t_wrapper18 header_links-item text-hover">Review</a>
                        <a href="#services" class="t_wrapper18 header_links-item text-hover">What we offer</a>
                        <a href="#help" class="t_wrapper18 header_links-item text-hover">Get Help</a>
                    </div>
                </div>
            </div>
        </div>
